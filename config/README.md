...
Las holguras **no son transferibles** entre impresoras ni entre materiales. Cada perfil nace con `calibrated: false` y valores por defecto para boquilla de 0.4 mm; se corrige imprimiendo la pieza de calibración (F2.15) e introduciendo las medidas reales.
